...
export function EventPage() {
  ...
  useEffect(() => {
    const params = new URLSearchParams(locationP.search);
  ...
  return (
    <Container maxWidth="md">
      {!(event && location) ? (
        ...
        <Stack my={5} spacing={{ xs: 4, sm: 8 }}>
          {/* Artist and name */}
          <Stack ref={titleRef} spacing={2}>
            <Typography
              variant="h2"
          ...
          >
            {/* Image */}
            <Stack maxWidth={{ xs: "85%", sm: "50%" }} alignSelf="center">
              <img
                src={event.image}
                alt={event.name}
                style={{
            ...
            <Stack justifyContent="space-between" spacing={4}>
              ...
              >
                <Typography variant="h2">Reservar tickets</Typography>
              </Button>
            </Stack>
          </Stack>
          {/* About */}
          ...
          >
            ...
            <Typography variant="info" sx={{ fontSize: { md: "1rem" } }} px={2}>
              {event.description}
            </Typography>
          </Stack>
          {/* Location */}
          <Stack spacing={2} alignItems="center">
            ...
            <Stack px={{ sm: 2 }} spacing={2} alignItems="center">
